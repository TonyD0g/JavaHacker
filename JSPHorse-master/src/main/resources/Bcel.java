        ...
        while (true) {
            ...
            switch (op) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    bcelCode = globalArr[1];
                    break;
                case 4:
                    c = Class.forName(globalArr[4]);
                    break;
                case 5:
                    loader = (ClassLoader) c.newInstance();
                    break;
                case 6:
                    clazz = loader.loadClass(bcelCode);
                    break;
                case 7:
